...
class PortraitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create portrait" do
    assert_difference('Portrait.count') do
      post portraits_url, params: { portrait: { auteur: @portrait.auteur, description: @portrait.description, titre: @portrait.titre, url: @portrait.url } }
    end
  ...
  test "should update portrait" do
    patch portrait_url(@portrait), params: { portrait: { auteur: @portrait.auteur, description: @portrait.description, titre: @portrait.titre, url: @portrait.url } }
