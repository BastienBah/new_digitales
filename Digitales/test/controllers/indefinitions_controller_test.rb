...
class IndefinitionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create indefinition" do
    assert_difference('Indefinition.count') do
      post indefinitions_url, params: { indefinition: { mot: @indefinition.mot, texte: @indefinition.texte, url: @indefinition.url } }
    end
  ...
  test "should update indefinition" do
    patch indefinition_url(@indefinition), params: { indefinition: { mot: @indefinition.mot, texte: @indefinition.texte, url: @indefinition.url } }
